...
import { UpdateQuoteServiceItemRequestDto } from '@infrastructure/http/quotes/dto/requests/update-quote-service-item-request.dto';
import { UpdateQuotePartSupplyItemRequestDto } from '@infrastructure/http/quotes/dto/requests/update-quote-part-supply-item-request.dto';
...
describe('QuotesController', () => {
  let httpController: QuotesController;
  let cleanController: QuoteController;
  ...
  beforeEach(() => {
    cleanController = new QuoteController(
      { execute: jest.fn() },
      { execute: jest.fn() },
      { execute: jest.fn() },
      { execute: jest.fn() },
    ...
    httpController = new QuotesController(cleanController);
  });
