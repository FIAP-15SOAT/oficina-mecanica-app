...
describe('PartsSuppliesController', () => {
  let httpController: PartsSuppliesController;
  let cleanController: PartSupplyController;
  ...
  beforeEach(() => {
    cleanController = new PartSupplyController(
      { execute: jest.fn() },
      { execute: jest.fn() },
      { execute: jest.fn() },
      { execute: jest.fn() },
    ...
    httpController = new PartsSuppliesController(cleanController);
  });
