...
import { StockMovementsController } from '@infrastructure/http/stock/stock-movements.controller';
...
import { FindStockMovementsQueryDto } from '@infrastructure/http/stock/dto/requests/filter-stock-movements.dto';
