...
export class PartSupplyResponseDto {
  @ApiProperty({ description: 'ID único da Peça ou Insumo', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' })
  id: string;
  ...
  @ApiPropertyOptional({ description: 'Número de referência do fabricante ou fornecedor', example: 'MANN-W712' })
  partNumber?: string;
  ...
  @ApiPropertyOptional({ description: 'Data de validade da Peça ou Insumo', example: '2026-12-31T00:00:00.000Z' })
  expiresAt?: Date;
